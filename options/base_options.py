...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--dataset_mode', type=str, default='unaligned', help='chooses how datasets are loaded. [unaligned | aligned | single | unpaired | aging]')
        ...
        parser.add_argument('--noref', action='store_true', help='if specified, print more debugging information')
        parser.add_argument('--residual', action='store_true', help='if specified, print more debugging information')
    ...
    def print_options(self, opt):
        ...
        os.system('cp /home/jacobwang/cyclegan/models/networks.py ' + expr_dir)
